    ...
    myIo.on('connection', (socket) => {
        ...
        socket.on('activate-email', (data) => {
            ...
            let transporter = nodemailer.createTransport({
                service: 'Gmail',
                auth: {
                    user: 'todo30091994@gmail.com',
                    pass: 'Password@94'
                }
            });
            let mailOptions = {
                from: '"ToDo" <Admin@ToDo.com>', // sender address
                to: data.email, // list of receivers
                subject: 'Welcome to ToDo', // Subject line
                html: `Hi ${data.firstName} ${data.lastName},<br><br>
                Welcome to the To Do App. It is used to create tasks with your friends and private as well.<br>Please Click <a href="http://localhost:4200/activate?activateToken=${data.activateUserToken}" >here</a> to verify your email and continue with our sevices.<br><br> Warm Regards,<br>ToDo Team` // html body
            };
        ...
        */
        ...
        socket.on('forgot-password', (data) => {
            ...
            let mailOptions = {
                ...
                html: `Hi,<br><br>If you are receiving this email, You have forgotten the password on ToDo.<br>To reset the password Click the <a href="http://localhost:4200/reset?passwordToken=${data.resetPasswordToken}">link</a><br><b>The link will expire in 5 minutes</b><br><br>Warm Regards,<br>Todo Team` // html body
            };
            transporter.sendMail(mailOptions, (error, info) => {
                if (error) {
                    return console.log(error);
